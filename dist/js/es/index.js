...
class ColorShader extends BaseShader {
    constructor() {
        super(...arguments);
        this._color = [1, 1, 0, 0];
    }
...
class DiffuseTwoColoredShader extends DiffuseShader {
    constructor() {
        super(...arguments);
...
class DiffuseTwoColoredSdfShader extends DiffuseTwoColoredShader {
    fillCode() {
        super.fillCode();
        this.fragmentShaderCode = `precision mediump float;
            varying vec2 vTextureCoord;
...
class CloudShader extends BaseShader {
    constructor() {
        super(...arguments);
        this._color = [1, 1, 0, 0];
        this._time = 0;
...
class PlaneTracesShader extends BaseShader {
    constructor() {
        super(...arguments);
        this._color = [1, 1, 0, 0];
    }
...
class Renderer extends BaseRenderer {
    constructor() {
        ...
        this.fmGroundColored = new FullModel();
        this.fmPlaneShadow = new FullModel();
        this.fmTrees = new FullModel();
        this.fmClouds = new FullModel();
        this.fmPlaneUnlit = new FullModel();
        this.fmPlaneLit = new FullModel();
        this.fmBus = new FullModel();
        this.fmPlaneTraces = new FullModel();
        this.fmPlaneDistant = new FullModel();
        this.fmLoader = new FullModel();
    ...
    positionCamera(a) {
        ...
        lookAt(this.mVMatrix, [eyeX, eyeY, eyeZ], // eye
        ...
        normalize(this.viewDir, this.viewDir);
        this.viewAngle = dot(this.viewDir, [0, 0, 1]);
    }
    ...
    calculateTransformMatricesWithBanking(tx, ty, tz, rx, ry, rz, sx, sy, sz, banking) {
        ...
        rotate(this.mMMatrix, this.mMMatrix, 0, [1, 0, 0]);
        ...
        rotateX(this.mMMatrix, this.mMMatrix, banking);
